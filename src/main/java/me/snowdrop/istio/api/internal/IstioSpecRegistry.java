...
public class IstioSpecRegistry {
    ...
    private static final String ISTIO_RBAC_PACKAGE_PREFIX = ISTIO_API_PACKAGE_PREFIX + ISTIO_VERSION + "rbac.";
    ...
    static {
        ...
        loadCRDInfosFromProperties("rbac_crds.properties", key -> ISTIO_RBAC_PACKAGE_PREFIX);
    }
